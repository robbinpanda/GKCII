...
struct MsgRadar_
{
  ...
  _num_right_type num_right;
   ...
   typedef std::vector< ::msgs::MsgRadarObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::msgs::MsgRadarObject_<ContainerAllocator> >> _objects_left_type;
  _objects_left_type objects_left;

   typedef std::vector< ::msgs::MsgRadarObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::msgs::MsgRadarObject_<ContainerAllocator> >> _objects_right_type;
