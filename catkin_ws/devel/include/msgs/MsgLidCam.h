...
struct MsgLidCam_
{
  ...
  _num_intersection_type num_intersection;
   ...
   typedef std::vector< ::msgs::MsgLidCamObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::msgs::MsgLidCamObject_<ContainerAllocator> >> _objects_circle_type;
  _objects_circle_type objects_circle;

   typedef std::vector< ::msgs::MsgLidCamObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::msgs::MsgLidCamObject_<ContainerAllocator> >> _objects_intersection_type;
