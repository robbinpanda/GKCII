...
struct SensorMsgsRadar_
{
  ...
  SensorMsgsRadar_(const ContainerAllocator& _alloc)
    ...
    , total_fsm4_tracks(0.0)
    , fsm4_tracker_counter(0.0)
    , fsm4_tracklist(_alloc)
    , rear_sbmp_tracklist(_alloc)
  ...
  _fsm4_tracker_counter_type fsm4_tracker_counter;
   ...
   typedef std::vector< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> >> _fsm4_tracklist_type;
  _fsm4_tracklist_type fsm4_tracklist;

   typedef std::vector< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> >> _rear_sbmp_tracklist_type;
  _rear_sbmp_tracklist_type rear_sbmp_tracklist;

   typedef std::vector< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> >> _front_esr_tracklist_type;
  _front_esr_tracklist_type front_esr_tracklist;

   typedef std::vector< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> >> _front_right_esr_tracklist_type;
  _front_right_esr_tracklist_type front_right_esr_tracklist;

   typedef std::vector< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> >> _front_left_esr_tracklist_type;
...
struct MD5Sum< ::per_msgs::SensorMsgsRadar_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x204a30d198cfa61fULL;
  static const uint64_t static_value2 = 0x97a58275109baa3eULL;
};
...
struct Printer< ::per_msgs::SensorMsgsRadar_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::per_msgs::SensorMsgsRadar_<ContainerAllocator>& v)
  {
    ...
    s << indent << "fsm4_tracklist[]" << std::endl;
    for (size_t i = 0; i < v.fsm4_tracklist.size(); ++i)
    {
      s << indent << "  fsm4_tracklist[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> >::stream(s, indent + "    ", v.fsm4_tracklist[i]);
    }
    s << indent << "rear_sbmp_tracklist[]" << std::endl;
    for (size_t i = 0; i < v.rear_sbmp_tracklist.size(); ++i)
    {
      s << indent << "  rear_sbmp_tracklist[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::per_msgs::GeometryMsgsRadarObject_<ContainerAllocator> >::stream(s, indent + "    ", v.rear_sbmp_tracklist[i]);
    }
