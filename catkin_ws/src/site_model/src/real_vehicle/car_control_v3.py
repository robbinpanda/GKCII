...
class carVehicleApiError(Exception):
    pass

# Class that interfaces with thea web page to control the car, load models, and receive camera data
class Client:
    def __init__(self, password, ip="127.0.0.1", name="car"):
        ...
        self.URL = (
            "https://" + self.ip + "/"
        )  # Main URL for logging onto car web page for first time
    ...
    def _get_csrf_token(self):
        ...
        # Get the CSRF Token and logon on to a car control interface session
        try:
