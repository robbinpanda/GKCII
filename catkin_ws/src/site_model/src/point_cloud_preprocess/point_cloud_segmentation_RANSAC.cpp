...
int main(int argc, char **argv)
{
    ...
    for(;i<31;i++)
    {
        ...
        pcl::io::loadPCDFile (package_path + "/dataset/point_cloud_data/pcd/combined/for_test/point_cloud_"+num+".pcd", cloud);
        ...
        //保存点云文件
        if(pcl::io::savePCDFileASCII (package_path + "/dataset/point_cloud_data/pcd/filtered/for_test/point_cloud_data_"+num+".pcd", cloud_segmented)>=0)
