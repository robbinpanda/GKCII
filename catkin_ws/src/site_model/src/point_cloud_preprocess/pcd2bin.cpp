...
int main (int argc, char **argv)
{
    ...
    for(;i<30;i++)
    {
      ...
      string in_file = package_path + "/dataset/point_cloud_data/pcd/filtered/for_test/point_cloud_data_"+to_string(i+1)+".pcd";
      string out_file = package_path + "/dataset/point_cloud_data/bin/for_test/point_cloud_data_"+to_string(i+1)+".bin";
