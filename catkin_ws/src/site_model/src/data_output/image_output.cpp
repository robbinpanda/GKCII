...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    ...
    std::string package_path = ros::package::getPath("site_model");     
    if(cv::imwrite(package_path + "/dataset/camera_data/image11.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    std::string package_path = ros::package::getPath("site_model");
    if(cv::imwrite(package_path + "/dataset/camera_data/image12.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    std::string package_path = ros::package::getPath("site_model");
    if(cv::imwrite(package_path + "/dataset/camera_data/image13.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    std::string package_path = ros::package::getPath("site_model");
    if(cv::imwrite(package_path + "/dataset/camera_data/image14.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    std::string package_path = ros::package::getPath("site_model");
    if(cv::imwrite(package_path + "/dataset/camera_data/image2.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    std::string package_path = ros::package::getPath("site_model");
    if(cv::imwrite(package_path + "/dataset/camera_data/image3.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    std::string package_path = ros::package::getPath("site_model");
    if(cv::imwrite(package_path + "/dataset/camera_data/image41.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    std::string package_path = ros::package::getPath("site_model");
    if(cv::imwrite(package_path + "/dataset/camera_data/image42.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    std::string package_path = ros::package::getPath("site_model");
    if(cv::imwrite(package_path + "/dataset/camera_data/image43.jpg",cv_bridge::toCvShare(msg)->image)>=0)
...
//sensor_msgs::Image ROS中image传递的消息形式
  try
  {
    cv::imshow("image2", cv_bridge::toCvShare(msg, "bgr8")->image);
    std::string package_path = ros::package::getPath("site_model");
    if(cv::imwrite(package_path + "/dataset/camera_data/image44.jpg",cv_bridge::toCvShare(msg)->image)>=0)
    {std::cerr << "Saved image44.jpg" << std::endl;}
   // cv::WaitKey(3);
  }
  catch (cv_bridge::Exception& e)
  {
