///////////////////////////////////////////////////////////////////////////////////
//   Copyright .com, Inc. or its affiliates. All Rights Reserved.          //
//                                                                               //
...
#include <car_drive_plugin/gazebo_ros_car_drive.hpp>
...
{
class GazeboRoscarDrivePrivate
{
public:
...
: impl_(std::make_unique<GazeboRoscarDrivePrivate>())
{
}
...
void GazeboRoscarDrive::Load(gazebo::physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  impl_->model_ = _model;
  ...
  impl_->cmd_vel_sub_ = impl_->ros_node_->create_subscription<geometry_msgs::msg::Twist>(
    ...
    std::bind(&GazeboRoscarDrivePrivate::OnCmdVel, impl_.get(), std::placeholders::_1));
  ...
  impl_->update_connection_ = gazebo::event::Events::ConnectWorldUpdateBegin(
    std::bind(&GazeboRoscarDrivePrivate::OnUpdate, impl_.get(), std::placeholders::_1));
...
void GazeboRoscarDrivePrivate::OnUpdate(const gazebo::common::UpdateInfo & _info)
{
...
void GazeboRoscarDrivePrivate::OnCmdVel(const geometry_msgs::msg::Twist::SharedPtr _msg)
{
...
void GazeboRoscarDrivePrivate::UpdateOdometryWorld()
{
...
void GazeboRoscarDrivePrivate::PublishOdometryTf(const gazebo::common::Time & _current_time)
{
...
void GazeboRoscarDrivePrivate::CalcTargetVelAndPosition(double& _target_speed, double& _target_left_steering, double& _target_right_steering)
{
...
void GazeboRoscarDrivePrivate::PublishJointVelAndPositionMsg(const double& _target_speed, const double& _target_left_steering, const double& _target_right_steering)
{
...
void GazeboRoscarDrivePrivate::PublishOdometryMsg(const gazebo::common::Time & _current_time)
{
  // Set covariance
