...
def set_throttle_steer(data):
    ...
    pub_vel_left_rear_wheel = rospy.Publisher('/ugv0/left_rear_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_right_rear_wheel = rospy.Publisher('/ugv0/right_rear_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_left_front_wheel = rospy.Publisher('/ugv0/left_front_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_right_front_wheel = rospy.Publisher('/ugv0/right_front_wheel_velocity_controller/command', Float64, queue_size=1)

    pub_pos_left_steering_hinge = rospy.Publisher('/ugv0/left_steering_hinge_position_controller/command', Float64, queue_size=1)
    pub_pos_right_steering_hinge = rospy.Publisher('/ugv0/right_steering_hinge_position_controller/command', Float64, queue_size=1)
...
def servo_commands():
    ...
    rospy.init_node('servo_commands0', anonymous=True)

    rospy.Subscriber("ugv0/ackermann_cmd_mux/output", AckermannDriveStamped, set_throttle_steer)
