...
def callback(msg0, msg1, msg2, msg3, msg4):
    ...
    result = np.concatenate((iris, rover0), axis=0)
...
def main():
    ...
    ts = message_filters.ApproximateTimeSynchronizer([iris0_sub, iris1_sub, rover0_sub0, rover0_sub1, rover0_sub2], 10, 1, allow_headerless=True)
