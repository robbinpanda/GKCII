...
class PandasetDataset(DatasetTemplate):
    ...
    def __getitem__(self, index):
        ...
        # predicted y back to world coordinates
    ...
    def _get_annotations(self,info, pose):
        ...
        ego_boxes = np.vstack([ego_xs, ego_ys, ego_zs, ego_dxs, ego_dys, ego_dzs, ego_y]).T
