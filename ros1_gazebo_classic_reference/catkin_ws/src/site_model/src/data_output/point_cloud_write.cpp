...
void cloudCB1(const sensor_msgs::PointCloud2 &input)
{
    ...
    if(pcl::io::savePCDFileASCII (package_path + "/dataset/point_cloud_data/pcd/initial/for_test/1/point_cloud1_"+num+".pcd", cloud)>=0)
...
void cloudCB2(const sensor_msgs::PointCloud2 &input)
{
    ...
    pcl::fromROSMsg(input, cloud);
    std::string package_path = ros::package::getPath("site_model");
    if(pcl::io::savePCDFileASCII (package_path + "/dataset/point_cloud_data/pcd/initial/for_test/2/point_cloud2_"+num+".pcd", cloud)>=0)
...
void cloudCB3(const sensor_msgs::PointCloud2 &input)
{
    ...
    pcl::fromROSMsg(input, cloud);
    std::string package_path = ros::package::getPath("site_model");
    if(pcl::io::savePCDFileASCII (package_path + "/dataset/point_cloud_data/pcd/initial/for_test/3/point_cloud3_"+num+".pcd", cloud)>=0)
