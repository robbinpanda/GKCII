...
void writter(const sensor_msgs::PointCloud2 &pcd, const msgs::MsgCamera &img, const nav_msgs::Odometry &odom)
{
    ...
    if(pcl::io::savePCDFileASCII (package_path + "/dataset/test_dataset/pcd/"+num+".pcd", cloud)>=0)
...
int main (int argc, char **argv)
{
    ...
    message_filters::Subscriber<nav_msgs::Odometry> odom_sub(nh, "/car1/base_pose_ground_truth", 1);
