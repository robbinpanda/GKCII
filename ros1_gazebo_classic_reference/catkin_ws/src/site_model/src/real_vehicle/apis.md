# Summary of  car Manual Mode APIs

The [ car webserver_pkg](https://github.com/car/car-webserver-pkg/blob/main/webserver_pkg/webserver_pkg/webserver_publisher_node.py) module creates the webserver_publisher_node which launches a Flask application as a background thread and creates service clients and subscribers for all the services and topics that are required by the APIs called from the car vehicle console.

## List of Exposed APIs

### Vehicle Control API

Code is here: https://github.com/car/car-webserver-pkg/blob/main/webserver_pkg/webserver_pkg/vehicle_control.py
...
Code is here: https://github.com/car/car-webserver-pkg/blob/main/webserver_pkg/webserver_pkg/device_info_api.py
