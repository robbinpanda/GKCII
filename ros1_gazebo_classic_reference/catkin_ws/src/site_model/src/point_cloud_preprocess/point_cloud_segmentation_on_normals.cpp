...
*/	// Load cloud in blob format
	...
	pcl::io::loadPCDFile(package_path + "/dataset/point_cloud_data/point_cloud_segmented_on_RANSAC.pcd", *cloud);
	...
	*/
	...
	if (VISUAL = 1)
	{
		...
		MView->addPointCloudNormals<pcl::PointXYZ, pcl::PointNormal>(cloud, normals_small_scale, 100, mean_radius * 10, "small_scale_normal");
		MView->addPointCloudNormals<pcl::PointXYZ, pcl::PointNormal>(cloud, normals_large_scale, 100, mean_radius * 10, "large_scale_normal");
