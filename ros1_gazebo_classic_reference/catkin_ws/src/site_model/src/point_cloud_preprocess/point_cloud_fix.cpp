...
int main()
{
	...
	for(;i<31;i++)
	{
		...
		pcl::io::loadPCDFile(package_path + "/dataset/point_cloud_data/pcd/initial/for_test/1/point_cloud1_"+num+".pcd", *cloud);
		...
		if(pcl::io::savePCDFileASCII (package_path + "/dataset/point_cloud_data/pcd/initial/for_test/1_fixed/point_cloud1_"+num+".pcd", *cloud)>=0)
	...
	{
		std::string num = std::to_string(i);
		pcl::io::loadPCDFile(package_path + "/dataset/point_cloud_data/pcd/initial/for_test/2/point_cloud2_"+num+".pcd", *cloud);
		...
		if(pcl::io::savePCDFileASCII (package_path + "/dataset/point_cloud_data/pcd/initial/for_test/2_fixed/point_cloud2_"+num+".pcd", *cloud)>=0)
	...
	{
		std::string num = std::to_string(i);
		pcl::io::loadPCDFile(package_path + "/dataset/point_cloud_data/pcd/initial/for_test/3/point_cloud3_"+num+".pcd", *cloud);
		...
		if(pcl::io::savePCDFileASCII (package_path + "/dataset/point_cloud_data/pcd/initial/for_test/3_fixed/point_cloud3_"+num+".pcd", *cloud)>=0)
