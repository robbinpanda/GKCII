...
int main(int argc, char **argv){
	...
	string infile = "/home/zonlin/IPP/OpenPCDet/data/kitti/training/velodyne/000000.bin";
 
	///The file to output to.
    	std::string package_path = ros::package::getPath("site_model");
	string outfile = package_path + "/dataset/point_cloud_data/bin2pcd/000000.pcd";
