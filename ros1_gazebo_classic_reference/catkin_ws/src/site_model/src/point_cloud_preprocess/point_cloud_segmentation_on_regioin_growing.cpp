...
int main(int argc, char** argv)
{
    ...
    if (pcl::io::loadPCDFile <pcl::PointXYZ>(package_path + "/dataset/point_cloud_data/point_cloud_segmented_on_RANSAC.pcd", *cloud) >= 0)
    ...
    {
        pcl::io::savePCDFile(package_path + "/dataset/point_cloud_data/point_cloud_segmented_on_region_growing.pcd", *colored_cloud);
