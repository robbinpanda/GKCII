...
# This sample uses the Message Broker for  IoT to send and receive messages
...
# --endpoint a1bzo7baf8mrhu-ats.iot.us-east-1..com 
# --ca_file root-CA.crt 
...
cmdUtils.register_command("port", "<int>", "Connection port.  IoT supports 443 and 8883 (optional, default=auto).", type=int)
...
def on_message_received_tag(topic, payload, dup, qos, retain, **kwargs):
    # print("Received message from topic '{}': {}".format(topic, payload))
    print("Received message from topic '{}'".format(topic), end='\r')
    global received_count, tag_msg
    tag_msg = payload
    print(tag_msg)
...
if __name__ == '__main__':
    ...
    # Subscribe
    print("Subscribing to topic '{}'...".format("car1/camera"))
    subscribe_future, packet_id = mqtt_connection.subscribe(
        topic="car1/camera",
        qos=mqtt.QoS.AT_LEAST_ONCE,
        callback=on_message_received_tag)
