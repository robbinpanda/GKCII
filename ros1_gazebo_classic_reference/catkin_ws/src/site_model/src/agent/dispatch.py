...
from ..real_vehicle._car_control_v3 import Client, carVehicleApiError
...
class Dispatch:
    ...
    def __init__(self, vehicle_num: int, scene_map: DynamicMap, evalagent=None, random: bool = False) -> None:
        ...
        self.controllers = [VehicleController('car{}'.format(i)) for i in range(1, N + 1)]
...
if __name__ == '__main__':
    ...
    sub_odoms = [message_filters.Subscriber('/car{}/base_pose_ground_truth'.format(i), Odometry) for i in range(1, N + 1)]
